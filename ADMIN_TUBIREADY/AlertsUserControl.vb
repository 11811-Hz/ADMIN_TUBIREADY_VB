...
Public Class AlertsUserControl
    ...
    Private connectionString As String = "Data Source=DESKTOP-RT61FIB\SQLEXPRESS;Initial Catalog=TubiReadyDB;Integrated Security=True;TrustServerCertificate=True"
    ...
    Private Sub LoadStreets()
        ...
        Dim query As String = "SELECT DISTINCT Street FROM Residents WHERE Street IS NOT NULL AND Street <> '' ORDER BY Street ASC;"
