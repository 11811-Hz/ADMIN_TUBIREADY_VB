...
Partial Class PendingUserControl
    ...
    Private Sub InitializeComponent()
        ...
        Guna2DataGridView1.Columns.AddRange(New DataGridViewColumn() {Checkbox, ResidentName, Role, Address, ContactNum, DateApplied, Accept, Reject})
        ...
        ' Accept
        ' 
        Accept.FlatStyle = FlatStyle.Popup
        Accept.HeaderText = ""
        Accept.Name = "Accept"
        ' 
        ' Reject
        ' 
        Reject.FlatStyle = FlatStyle.Popup
        Reject.HeaderText = ""
        Reject.Name = "Reject"
        ' 
        ' PendingUserControl
    ...
    Friend WithEvents Accept As DataGridViewButtonColumn
